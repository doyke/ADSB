/*
版权所有：版权所有(C) 2012
文件名称：UserDepartmentPosition.cs
系统编号：ADSB_SYS001
系统名称：ADSB框架
组件编号：ADSB_CN002
组件名称：基本表
设计作者：自动生成
完成日期：2012-09-10
内容摘要：表[UserDepartmentPosition]对应的实体类
...
{
    /// <summary>
    /// 类 名 称：UserDepartmentPosition
    /// 完成日期：2012-09-10
    /// 编码作者：自动生成
    /// 内容摘要：包含实体的信息,映射数据库[UserDepartmentPosition]表
    /// </summary>
    [Serializable]
    public class UserDepartmentPosition
    {
        ...
        public virtual System.Int32 UserPostion { get; set; }
