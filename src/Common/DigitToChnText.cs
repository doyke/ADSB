...
namespace BruceFramework.Common
{
    ...
    /// 编码人员:卢小龙
    /// 完成日期:2010-06-19
    /// 内    容：完成数字到中文大写的转换，也可转换为大写人民币形式
    public class DigitToChnText
    {
        private char[] chnGenText = new char[] { '零', '一', '二', '三', '四', '五', '六', '七', '八', '九' };
        private char[] chnGenDigit = new char[] { '十', '百', '千', '万', '亿' };
        private char[] chnRMBText = new char[] { '零', '壹', '贰', '叁', '肆', '伍', '陆', '染', '捌', '玖' };
        private char[] chnRMBDigit = new char[] { '拾', '佰', '仟', '萬', '億' };
        private char[] chnRMBUnit = new char[] { '拾', '佰', '仟', '萬', '億' };
        ...
        /// 检查输入数字有效性
        /// </summary>
        /// <param name="strDigit">数字字符串</param>
        /// <param name="bToRMB">是否转换成人民币</param>
